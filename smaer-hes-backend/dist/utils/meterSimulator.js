...
exports.startMeterSimulator = startMeterSimulator;
exports.simulateAllMeters = simulateAllMeters;
exports.simulateAnomaly = simulateAnomaly;
...
async function sendMeterData(meterData) {
    try {
        const response = await axios_1.default.post(`${API_URL}/meters/data-ingestion`, meterData);
...
async function simulateAnomaly(meterNumber, anomalyType) {
...
//# sourceMappingURL=meterSimulator.js.map