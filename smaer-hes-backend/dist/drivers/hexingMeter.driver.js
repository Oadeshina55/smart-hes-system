...
class HexingMeterDriver {
    ...
    async connect() {
        try {
            ...
            logger_1.default.info(`Connected to Hexing meter at ${this.config.host}:${this.config.port}`);
        }
        catch (error) {
            logger_1.default.error(`Failed to connect to Hexing meter: ${error.message}`);
            throw error;
        }
    }
    /**
...
exports.default = HexingMeterDriver;
//# sourceMappingURL=hexingMeter.driver.js.map